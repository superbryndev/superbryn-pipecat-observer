...
[![PyPI version](https://img.shields.io/badge/pypi-v0.6.10-orange)](https://pypi.org/project/superbryn-pipecat-observer/)
...
```json
{
  ...
  "sdk_version": "@superbryn/pipecat-observer@0.6.10",
  "call": {
    ...
    "metadata": {
      ...
      "tts_voice_id": "...",
      "pipeline_version": "@superbryn/pipecat-observer@0.6.10",
      "mode": "observe"
    },
    "usage": {
